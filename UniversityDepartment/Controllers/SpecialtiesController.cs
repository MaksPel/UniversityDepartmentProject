...
using UniversityDepartment.ViewModels.Specialties;
using UniversityDepartment.ViewModels;

namespace UniversityDepartment.Controllers
{
    public class SpecialtiesController : Controller
    {
        ...
        public SpecialtiesController(UniversityDepartmentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SpecialtyId,Name,DepartmentId")] Specialty specialty)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Departments, "DepartmentId", "DepartmentId", specialty.DepartmentId);
            return View(specialty);
        }
